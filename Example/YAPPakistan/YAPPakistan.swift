...
func yapPakistanMainContainer() -> YAPPakistanMainContainer {
    let configuration = YAPPakistanConfiguration(environment: .current, googleMapsAPIKey: "AIzaSyCy_1KJ3iHy2SSQDo3Q35YS96vNDx4xZuI", buildConfig: ("1.0", "1.0"), callback: eventCallback)
