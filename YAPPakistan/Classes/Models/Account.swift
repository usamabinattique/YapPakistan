...
public struct Account: Codable {
    ...
    public var accountStatus: AccountStatus? = AccountStatus.cardSchemePending //{ AccountStatus(rawValue: _accountStatus ?? "") }
    private var _accountStatus: String?
    public let customer: Customer
    public let bank: Bank
    public var parnterBankStatus: PartnerBankStatus? = PartnerBankStatus.physicalCardPending //{ PartnerBankStatus(rawValue: _parnterBankStatus ?? "") }
