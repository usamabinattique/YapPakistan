//
//  OnBoardingTopupCardCVVViewController.swift
//  YAPPakistan
//
...
class OnBoardingTopupCardCVVViewController: UIViewController {
    
    // MARK: Views
    
    private lazy var cardImage = UIFactory.makeImageView(contentMode: .scaleAspectFit ) //UIImageViewFactory.createBackgroundImageView(mode: .scaleAspectFit)
    
    private lazy var cardTitle = UIFactory.makeLabel(font: .large, alignment: .center) // UILabelFactory.createUILabel(with: .primaryDark, textStyle: .large, alignment: .center)
    
    private lazy var cardNumber = UIFactory.makeLabel(font: .micro, alignment: .center) //UILabelFactory.createUILabel(with: .greyDark, textStyle: .micro, alignment: .center)
    
    private lazy var amount = UIFactory.makeLabel(font: .micro, alignment: .center, numberOfLines: 0,lineBreakMode: .byWordWrapping) //UILabelFactory.createUILabel(with: .greyDark, textStyle: .micro, alignment: .center, numberOfLines: 0, lineBreakMode: .byWordWrapping)
    ...
    private var viewModel: OnBoardingTopupCardCVVViewModelType!
    private let disposeBag = DisposeBag()
    private var themeService: ThemeService<AppTheme>
    
    // MARK: Initialization
    init(themeService: ThemeService<AppTheme>, viewModel: OnBoardingTopupCardCVVViewModelType) {
...
private extension OnBoardingTopupCardCVVViewController {
    func setupViews() {
...
extension OnBoardingTopupCardCVVViewController: UITextFieldDelegate {
