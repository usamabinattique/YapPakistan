...
extension PasscodeViewController {
    ...
    fileprivate func setupConstraints() {
        ...
        headingLabel
            ...
            .alignEdgeWithSuperviewSafeArea(.top, constant: ///UIScreen.screenType == .iPhone5 || UIScreen.screenType == .iPhone6 || UIScreen.screenType == .iPhone6Plus ? 0 : 10
                                                10)
        ...
        buttonStack
            ...
            .toBottomOf(passcodeKeys, .greaterThanOrEqualTo, constant: ///UIScreen.screenType == .iPhone5 || UIScreen.screenType == .iPhone6 || UIScreen.screenType == .iPhone6Plus ? 20 : 10
                            10)
            .centerHorizontallyInSuperview()
        ...
        forgotPasswordButton
            .height(constant: /*UIScreen.screenType == .iPhone5 || UIScreen.screenType == .iPhone6 ? 22:*/
                        30)
            .width(constant: 200)
    }
