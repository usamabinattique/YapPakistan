...
class TransactionTableViewCell: RxUITableViewCell {
    ...
    private lazy var timeDate = UIFactory.makeLabel(font: .small, alignment: .right) //UILabelFactory.createUILabel(with: .greyDark, textStyle: .small)
    ...
    private var viewModel: TransactionTabelViewCellViewModelType!
