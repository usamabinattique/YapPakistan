...
protocol SendMoneyHomeBeneficiaryCellViewModelInput {

}

protocol SendMoneyHomeBeneficiaryCellViewModelOutput {
...
protocol SendMoneyHomeBeneficiaryCellViewModelType {
    var inputs: SendMoneyHomeBeneficiaryCellViewModelInput { get }
    var outputs: SendMoneyHomeBeneficiaryCellViewModelOutput { get }
}

class SendMoneyHomeBeneficiaryCellViewModel: SendMoneyHomeBeneficiaryCellViewModelType, SendMoneyHomeBeneficiaryCellViewModelInput, SendMoneyHomeBeneficiaryCellViewModelOutput, ReusableTableViewCellViewModelType {
    
    // MARK: - Properties
    let disposeBag = DisposeBag()
    var inputs: SendMoneyHomeBeneficiaryCellViewModelInput { return self }
    var outputs: SendMoneyHomeBeneficiaryCellViewModelOutput { return self }
