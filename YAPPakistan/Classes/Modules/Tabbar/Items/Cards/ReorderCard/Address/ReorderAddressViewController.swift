//
//  ReorderAddressViewController.swift
//  YAPPakistan
//
...
class ReorderAddressViewController: UIViewController {
    ...
    var viewModel: ReorderAddressViewModelType!

    convenience init(themeService: ThemeService<AppTheme>,
                     viewModel: ReorderAddressViewModelType) {
...
extension ReorderAddressViewController {
...
extension ReorderAddressViewController: GMSAutocompleteViewControllerDelegate {
