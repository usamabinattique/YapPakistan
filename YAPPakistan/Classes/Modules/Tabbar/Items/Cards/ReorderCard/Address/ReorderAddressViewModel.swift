...
protocol ReorderAddressViewModelInput {
...
protocol ReorderAddressViewModelOutput {
    ...
    var languageStrings: Observable<ReorderAddressViewModel.LanguageStrings> { get }
}

protocol ReorderAddressViewModelType {
    var inputs: ReorderAddressViewModelInput { get }
    var outputs: ReorderAddressViewModelOutput { get }
}

class ReorderAddressViewModel: ReorderAddressViewModelType, ReorderAddressViewModelInput, ReorderAddressViewModelOutput {
    ...
    var inputs: ReorderAddressViewModelInput { return self }
    var outputs: ReorderAddressViewModelOutput { return self }
...
fileprivate extension ReorderAddressViewModel {
    func languageSetup() {
