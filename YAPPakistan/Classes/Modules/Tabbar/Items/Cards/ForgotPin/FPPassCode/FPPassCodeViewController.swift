//
//  FPPassCodeViewController.swift
//  YAPPakistan
//
...
class FPPassCodeViewController: UIViewController {
    ...
    var viewModel: FPPassCodeViewModelType!

    // MARK: - Init
    convenience init(themeService: ThemeService<AppTheme>,
                     viewModel: FPPassCodeViewModelType) {
...
// MARK: - Setup
fileprivate extension FPPassCodeViewController {
