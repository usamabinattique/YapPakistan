//
//  FPNewPinConfirmViewController.swift
//  YAPPakistan
//
...
class FPNewPinConfirmViewController: UIViewController {
    ...
    var viewModel: FPNewPinConfirmViewModelType!

    // MARK: - Init
    convenience init(themeService: ThemeService<AppTheme>,
                     viewModel: FPNewPinConfirmViewModelType) {
...
// MARK: - Setup
fileprivate extension FPNewPinConfirmViewController {
