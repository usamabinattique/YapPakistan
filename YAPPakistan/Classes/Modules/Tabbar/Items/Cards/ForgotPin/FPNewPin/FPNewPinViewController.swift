...
class FPNewPinViewController: UIViewController {
    ...
    var viewModel: FPNewPinViewModelType!

    // MARK: - Init
    convenience init(themeService: ThemeService<AppTheme>,
                     viewModel: FPNewPinViewModelType) {
...
// MARK: - Setup
fileprivate extension FPNewPinViewController {
