//
//  NewPinConfirmViewController.swift
//  YAPPakistan
//
...
class NewPinConfirmViewController: UIViewController {
    ...
    var viewModel: NewPinConfirmViewModelType!

    // MARK: - Init
    convenience init(themeService: ThemeService<AppTheme>,
                     viewModel: NewPinConfirmViewModelType) {
...
// MARK: - Setup
fileprivate extension NewPinConfirmViewController {
