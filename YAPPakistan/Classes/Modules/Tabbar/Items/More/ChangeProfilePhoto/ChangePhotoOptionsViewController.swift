//
//  ChangePhotoOptionsViewController.swift
//  YAPPakistan
//
//  Created by Awais on 29/04/2022.
//
...
class ChangeProfilePhotoOptionsViewController: UIViewController {
...
//    }()
    ...
    public lazy var headerTitle: UILabel = UIFactory.makeLabel(font: .title3, text: "Update profile photo") //.primaryDark
    ...
    private lazy var cameraButton = UIButtonFactory.createButton(title: "Open Camera", backgroundColor: .white, textColor: .black)
    
    private lazy var photoLibraryButton = UIButtonFactory.createButton(title: "Open Camera", backgroundColor: .white, textColor: .black)
    
    private lazy var removePhototButton = UIButtonFactory.createButton(title: "Open Camera", backgroundColor: .white, textColor: .black)
...
private extension ChangeProfilePhotoOptionsViewController {
    func setupTheme() {
//        themeService.rx
...
//            .bind({ UIColor($0.primaryDark) }, to: [name.rx.detailsColor, phone.rx.detailsColor, shareButton.rx.backgroundColor])
    ...
    func setupViews() {
        ...
        stackView.addArrangedSubview(removePhototButton)
...
extension ChangeProfilePhotoOptionsViewController {
    @objc
