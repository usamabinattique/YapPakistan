...
protocol TransactionsServiceType {
    ...
    func paymentGatewayTopup<T: Codable>(threeDSecureId: String, orderId: String, currency: String, amount: String, sessionId: String, securityCode: String?) -> Observable<T>
}
...
//        let route = TransactionsRouter.getFee(input)
    ...
    public func createCheckoutSession<T: Codable>(amount: String, currency: String, sessionId: String) -> Observable<T> {
        let body = PaymentGatewayRequest(order: PaymentGatewayAmountRequest(amount: amount, currency: currency), session: PaymentGatewaySessionRequest(id: sessionId))
    ...
    public func paymentGatewayTopup<T: Codable>(threeDSecureId: String, orderId: String, currency: String, amount: String, sessionId: String, securityCode: String?) -> Observable<T> {
        let pathVariables = [orderId]
        let body = OrderCardRequest(threeDSecureId: threeDSecureId, order: PaymentGatewayAmountRequest(id: orderId, amount: amount, currency: currency), session: PaymentGatewaySessionRequest(id: sessionId), securityCode: securityCode)
